...
// Hash: aecdbc6199e6cc01abf0e2202e498c397fdbac98aa9570d357f41e9c16a94bc6
// Version: 0.1.3
package qbft
...
func (s *SignedMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FullData'
	if size := len(s.FullData); size > 6354228 {
		err = ssz.ErrBytesLengthFn("SignedMessage.FullData", size, 6354228)
		return
	}
...
func (s *SignedMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'FullData'
	{
		...
		hh.MerkleizeWithMixin(elemIndx, byteLen, (6354228+31)/32)
	}
