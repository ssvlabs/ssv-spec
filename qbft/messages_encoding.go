...
// Hash: 0fa30cda23930bd675d149ac769ccef2b3bc4cb842299c5508e6a0e3a3411195
// Version: 0.1.3
package qbft
...
func (m *Message) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (8) 'CommitExtraLoad'
	dst = ssz.WriteOffset(dst, offset)
	offset += m.CommitExtraLoad.SizeSSZ()
	...
	// Field (8) 'CommitExtraLoad'
	if dst, err = m.CommitExtraLoad.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (m *Message) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (8) 'CommitExtraLoad'
	if o8 = ssz.ReadOffset(buf[76:80]); o8 > size || o7 > o8 {
		return ssz.ErrOffset
	}
	...
	{
		buf = tail[o8:]
		if err = m.CommitExtraLoad.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
func (m *Message) SizeSSZ() (size int) {
	...
	// Field (8) 'CommitExtraLoad'
	size += m.CommitExtraLoad.SizeSSZ()
...
func (m *Message) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (8) 'CommitExtraLoad'
	if err = m.CommitExtraLoad.HashTreeRootWith(hh); err != nil {
		return
	}
