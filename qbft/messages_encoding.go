...
// Hash: d5248d1d4e9c8569a945bf2fc6d8235c9223e51c6fd2dd4890b7e1884002fc03
// Version: 0.1.2
package qbft
...
func (s *SignedMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FullData'
	if size := len(s.FullData); size > 4219064 {
		err = ssz.ErrBytesLengthFn("SignedMessage.FullData", size, 4219064)
		return
	}
...
func (s *SignedMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'FullData'
	{
		...
		hh.MerkleizeWithMixin(elemIndx, byteLen, (4219064+31)/32)
	}
