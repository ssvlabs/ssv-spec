...
// Hash: c2a8d3c13ffe39ee0f0706ca088174804ab5bc2b630ef8803eee6bb97baf224b
// Version: 0.1.3
package qbft
...
func (s *SignedMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FullData'
	if size := len(s.FullData); size > 6029864 {
		err = ssz.ErrBytesLengthFn("SignedMessage.FullData", size, 6029864)
		return
	}
...
func (s *SignedMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'FullData'
	{
		...
		hh.MerkleizeWithMixin(elemIndx, byteLen, (6029864+31)/32)
	}
