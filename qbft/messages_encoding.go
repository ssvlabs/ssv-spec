...
// Hash: 7bacc9666c02474e65c50cd2a27b4902c90717f20d11e2884c7b29c1cec1828d
// Version: 0.1.3
package qbft
...
func (s *SignedMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FullData'
	if size := len(s.FullData); size > 4461956 {
		err = ssz.ErrBytesLengthFn("SignedMessage.FullData", size, 4461956)
		return
	}
...
func (s *SignedMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'FullData'
	{
		...
		hh.MerkleizeWithMixin(elemIndx, byteLen, (4461956+31)/32)
	}
