...
func LateDecidedBiggerQuorum() tests.SpecTest {
	...
	msgs = append(msgs, testingutils.TestingCommitMultiSignerMessage([]*rsa.PrivateKey{ks.NetworkKeys[1], ks.NetworkKeys[2], ks.NetworkKeys[3], ks.NetworkKeys[4]}, []types.OperatorID{1, 2, 3, 4}))
		...
		RunInstanceData: []*tests.RunInstanceData{
			{
				...
				ExpectedDecidedState: tests.DecidedState{
					...
					BroadcastedDecided: testingutils.TestingCommitMultiSignerMessage([]*rsa.PrivateKey{ks.NetworkKeys[1], ks.NetworkKeys[2], ks.NetworkKeys[3]}, []types.OperatorID{1, 2, 3}),
				},
