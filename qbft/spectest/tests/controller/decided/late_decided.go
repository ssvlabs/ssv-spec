...
func LateDecided() tests.SpecTest {
	...
	msgs = append(msgs, testingutils.TestingCommitMultiSignerMessage([]*rsa.PrivateKey{ks.NetworkKeys[1], ks.NetworkKeys[2], ks.NetworkKeys[4]}, []types.OperatorID{1, 2, 4}))
