...
func ImparsableRoundChangeData() *tests.MsgProcessingSpecTest {
	...
	return &tests.MsgProcessingSpecTest{
		...
		ExpectedError:  "invalid round change message: could not get roundChange data : could not decode round change data from message: invalid character '\\x01' looking for beginning of value",
	}
}
