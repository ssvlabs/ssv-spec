...
func InvalidPrepareJustificationValue() *tests.MsgProcessingSpecTest {
	...
	return &tests.MsgProcessingSpecTest{
		...
		ExpectedError:  "invalid proposal message: proposal not justified: change round msg not valid: round change justification invalid: prepare data != proposed data",
	}
}
