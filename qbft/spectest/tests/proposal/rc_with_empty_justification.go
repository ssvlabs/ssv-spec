...
// RCWithEmptyJustification tests a proposal for > 1 round with RC messages with empty justification (valid Proposal, since RC justification is not checked)
func RCWithEmptyJustification() tests.SpecTest {
	...
	return &tests.MsgProcessingSpecTest{
		Name:          "rc with empty justifications (valid proposal)",
		Pre:           pre,
		InputMessages: msgs,
