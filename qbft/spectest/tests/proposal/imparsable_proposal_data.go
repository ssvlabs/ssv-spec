...
func ImparsableProposalData() *tests.MsgProcessingSpecTest {
	...
	return &tests.MsgProcessingSpecTest{
		...
		InputMessages: msgs,
		ExpectedError: "invalid proposal message: could not get proposal data: could not decode proposal data from message: invalid character '\\x01' looking for beginning of value",
	}
}
