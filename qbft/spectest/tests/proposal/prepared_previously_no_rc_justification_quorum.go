...
// PreparedPreviouslyNoRoundChangeJustificationQuorum tests a proposal for > 1 round, prepared previously but without quorum of prepared msgs justification
func PreparedPreviouslyNoRoundChangeJustificationQuorum() tests.SpecTest {
	pre := testingutils.BaseInstance()
	ks := testingutils.Testing4SharesSet()
	sc := preparedPreviouslyNoRoundChangeJustificationQuorumStateComparison()
...
func preparedPreviouslyNoRoundChangeJustificationQuorumStateComparison() *comparable.StateComparison {
