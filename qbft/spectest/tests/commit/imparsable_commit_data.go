...
func ImparsableCommitData() *tests.MsgProcessingSpecTest {
	...
	return &tests.MsgProcessingSpecTest{
		...
		InputMessages: msgs,
		ExpectedError: "invalid commit message: could not get msg commit data: could not decode commit data from message: invalid character '\\x01' looking for beginning of value",
