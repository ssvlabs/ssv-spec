...
func (r *AttesterRunner) ProcessPreConsensus(signedMsg *types.PartialSignatureMessages) error {
...
func (r *AttesterRunner) ProcessPostConsensus(signedMsg *types.PartialSignatureMessages) error {
