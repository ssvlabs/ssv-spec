...
func (r *AttesterRunner) ProcessPreConsensus(signedMsg *SignedPartialSignature) error {
...
func (r *AttesterRunner) ProcessPostConsensus(signedMsg *SignedPartialSignature) error {
