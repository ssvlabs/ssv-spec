...
func (r *AttesterRunner) ProcessPreConsensus(signedMsg *SignedPartialSignatures) error {
...
func (r *AttesterRunner) ProcessPostConsensus(signedMsg *SignedPartialSignatures) error {
