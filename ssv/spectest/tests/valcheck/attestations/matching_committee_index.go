...
func DutyCommitteeIndexNotMatchingAttestations() *tests.SpecTest {
	...
	return &tests.SpecTest{
		...
		ExpectedError:           "failed to process valcheck msg: could not process msg: invalid proposal message: proposal not justified: proposal value invalid: attestation data CommitteeIndex != duty CommitteeIndex",
	}
}
