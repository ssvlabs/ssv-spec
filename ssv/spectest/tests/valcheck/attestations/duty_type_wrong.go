...
func DutyTypeWrong() *tests.SpecTest {
	...
	return &tests.SpecTest{
		...
		ExpectedError:           "failed to process valcheck msg: could not process msg: invalid proposal message: proposal not justified: proposal value invalid: duty type != RoleTypeAttester",
	}
}
