...
// AccepsBlindedBlockFullHappyFlow tests a full happy flow for a proposer runner that produces normal blocks but receives as proposal a blinded block
func AcceptsBlindedBlockFullHappyFlow() tests.SpecTest {
