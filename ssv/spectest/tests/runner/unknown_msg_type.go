...
// UnknownMsgType tests an invalid message with an unknown MsgType
func UnknownMsgType() tests.SpecTest {

	unknownMsgType := func(msg *types.SignedSSVMessage) *types.SignedSSVMessage {
		msg.SSVMessage.MsgType = 100
		return msg
	}

	expectedError := "invalid SignedSSVMessage: invalid msg type"
		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SignedSSVMessage{
					unknownMsgType(testingutils.TestingProposalMessageWithIdentifierAndFullData(
