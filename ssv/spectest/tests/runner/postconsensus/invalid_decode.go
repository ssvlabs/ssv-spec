		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SignedSSVMessage{
					invalidF(testingutils.SignedSSVMessageWithSigner(1, ks.NetworkKeys[1], testingutils.SSVMsgSyncCommitteeContribution(nil, testingutils.PostConsensusSyncCommitteeContributionMsg(ks.Shares[1], 1, ks)))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					invalidF(testingutils.SignedSSVMessageWithSigner(1, ks.NetworkKeys[1], testingutils.SSVMsgSyncCommittee(nil, testingutils.PostConsensusSyncCommitteeMsg(ks.Shares[1], 1)))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					invalidF(testingutils.SignedSSVMessageWithSigner(1, ks.NetworkKeys[1], testingutils.SSVMsgProposer(nil, testingutils.PostConsensusProposerMsgV(ks.Shares[1], 1, spec.DataVersionDeneb)))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					invalidF(testingutils.SignedSSVMessageWithSigner(1, ks.NetworkKeys[1], testingutils.SSVMsgAggregator(nil, testingutils.PostConsensusAggregatorMsg(ks.Shares[1], 1)))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					invalidF(testingutils.SignedSSVMessageWithSigner(1, ks.NetworkKeys[1], testingutils.SSVMsgAttester(nil, testingutils.PostConsensusAttestationMsg(ks.Shares[1], 1, qbft.FirstHeight)))),
				},
