...
func InvalidMessage() *tests.MultiMsgProcessingSpecTest {
	...
	invaldiateMsg := func(msg *types.SignedPartialSignatureMessage) *types.SignedPartialSignatureMessage {
		msg.Signature = nil
		return msg
	}
	...
	return &tests.MultiMsgProcessingSpecTest{
		...
		Tests: []*tests.MsgProcessingSpecTest{
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgProposer(nil, invaldiateMsg(testingutils.PostConsensusProposerMsg(ks.Shares[1], 1, spec.DataVersionBellatrix))),
				},
