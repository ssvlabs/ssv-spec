		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SignedSSVMessage{
					changeRootsAndPrepareMsg(testingutils.TestContributionProofWithJustificationsConsensusData(ks), testingutils.SyncCommitteeContributionMsgID),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					changeRootsAndPrepareMsg(testingutils.TestSelectionProofWithJustificationsConsensusData(ks), testingutils.AggregatorMsgID),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					changeRootsAndPrepareMsg(testingutils.TestProposerWithJustificationsConsensusDataV(ks, spec.DataVersionDeneb), testingutils.ProposerMsgID),
				},
			...
			},
			{
				...
				Duty:   testingutils.TestingProposerDutyV(spec.DataVersionDeneb),
				Messages: []*types.SignedSSVMessage{
					changeRootsAndPrepareMsg(testingutils.TestProposerBlindedWithJustificationsConsensusDataV(ks, spec.DataVersionDeneb), testingutils.ProposerMsgID),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					changeRootsAndPrepareMsg(testingutils.TestAttesterConsensusData, testingutils.AttesterMsgID),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					changeRootsAndPrepareMsg(testingutils.TestSyncCommitteeConsensusData, testingutils.SyncCommitteeMsgID),
				},
