...
func InconsistentRoots() tests.SpecTest {
	...
	// changeRootsAndCreateMsg will change signing roots
	changeRootsAndCreateMsg := func(obj *types.ConsensusData, id []byte) *qbft.SignedMessage {
		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgSyncCommitteeContribution(changeRootsAndCreateMsg(testingutils.TestContributionProofWithJustificationsConsensusData(ks), testingutils.SyncCommitteeContributionMsgID), nil),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgAggregator(changeRootsAndCreateMsg(testingutils.TestSelectionProofWithJustificationsConsensusData(ks), testingutils.AggregatorMsgID), nil),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgProposer(changeRootsAndCreateMsg(testingutils.TestProposerWithJustificationsConsensusDataV(ks, spec.DataVersionBellatrix), testingutils.ProposerMsgID), nil),
				},
			...
			},
			{
				...
				Duty:   testingutils.TestingProposerDutyV(spec.DataVersionBellatrix),
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgProposer(changeRootsAndCreateMsg(testingutils.TestProposerBlindedWithJustificationsConsensusDataV(ks, spec.DataVersionBellatrix), testingutils.ProposerMsgID), nil),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgAttester(changeRootsAndCreateMsg(testingutils.TestAttesterConsensusData, testingutils.AttesterMsgID), nil),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgSyncCommittee(changeRootsAndCreateMsg(testingutils.TestSyncCommitteeConsensusData, testingutils.SyncCommitteeMsgID), nil),
				},
