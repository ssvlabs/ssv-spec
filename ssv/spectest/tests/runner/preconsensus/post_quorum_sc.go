...
// postQuorumCBSigningSC returns state comparison object for the PostQuorum CBSigning versioned spec test
func postQuorumCBSigningSC() *comparable.StateComparison {
	ks := testingutils.Testing4SharesSet()
