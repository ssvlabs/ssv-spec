...
// UnknownSigner tests SignedPartialSignatures unknown signer
		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.Message{
					testingutils.SSVMsgSyncCommitteeContribution(nil, testingutils.PreConsensusContributionProofMsg(ks.Shares[1], ks.Shares[1], 5, 1), types.PartialSelectionProofSignatureMsgType),
				},
			...
			},
			{
				...
				Messages: []*types.Message{
					testingutils.SSVMsgAggregator(nil, testingutils.PreConsensusSelectionProofMsg(ks.Shares[1], ks.Shares[1], 5, 1), types.PartialSelectionProofSignatureMsgType),
				},
			...
			},
			{
				...
				Messages: []*types.Message{
					testingutils.SSVMsgProposer(nil, testingutils.PreConsensusRandaoDifferentSignerMsg(ks.Shares[1], ks.Shares[1], 5, 1), types.PartialRandaoSignatureMsgType),
				},
