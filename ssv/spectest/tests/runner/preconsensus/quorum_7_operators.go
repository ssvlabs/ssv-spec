...
// Quorum7Operators  tests a quorum of valid SignedPartialSignature (7 operators)
		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				PostDutyRunnerStateRoot: "03490089fbe517f5e26a16f08174cc04630e4be6cf26b75b285753bb941878f1",
