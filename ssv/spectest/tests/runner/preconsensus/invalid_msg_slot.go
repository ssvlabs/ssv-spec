		...
		[]*tests.MsgProcessingSpecTest{
			{
				...
				ExpectedError: "failed processing sync committee selection proof message: invalid pre-consensus message: future partial sig msg, message slot: 50, want slot: 12",
			},
			{
				Name:   "randao",
				...
				ExpectedError: "failed processing randao message: invalid pre-consensus message: invalid partial sig slot: 50, want: 7413760",
			},
			{
			...
			},
			{
				...
				ExpectedError: "failed processing validator registration message: invalid pre-consensus message: future partial sig msg, message slot: 50, want slot: 12",
			},
			{
				Name:   "voluntary exit",
				...
				ExpectedError: "failed processing voluntary exit message: invalid pre-consensus message: future partial sig msg, message slot: 50, want slot: 12",
			},
			{
				...
				ExpectedError: "failed processing selection proof message: invalid pre-consensus message: future partial sig msg, message slot: 50, want slot: 12",
			},
			{
				...
				ExpectedError: "failed processing selection proof message: invalid pre-consensus message: invalid partial sig slot: 50, want: 7424012",
			},
		},
		ks,
	)
