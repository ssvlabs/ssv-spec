...
// InvalidMessageSlot tests a valid PartialSignatureMessage with an invalid msg slot
		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgSyncCommitteeContribution(1, ks.NetworkKeys[1], nil, invalidateSlot(testingutils.PreConsensusContributionProofMsg(ks.Shares[1], 1))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgAggregator(1, ks.NetworkKeys[1], nil, invalidateSlot(testingutils.PreConsensusSelectionProofMsg(ks.Shares[1], 1))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgProposer(1, ks.NetworkKeys[1], nil, invalidateSlot(testingutils.PreConsensusRandaoDifferentSignerMsgV(ks.Shares[1], 1, spec.DataVersionDeneb))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgAttester(1, ks.NetworkKeys[1], nil, invalidateSlot(testingutils.PreConsensusFailedMsg(ks.Shares[1], 1))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgSyncCommittee(1, ks.NetworkKeys[1], nil, invalidateSlot(testingutils.PreConsensusFailedMsg(ks.Shares[1], 1))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgValidatorRegistration(1, ks.NetworkKeys[1], nil, invalidateSlot(testingutils.PreConsensusValidatorRegistrationMsg(ks.Shares[1], 1))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgVoluntaryExit(1, ks.NetworkKeys[1], nil, invalidateSlot(testingutils.PreConsensusVoluntaryExitMsg(ks.Shares[1], 1))),
				},
				PostDutyRunnerStateRoot: "2ac409163b617c79a2a11d3919d6834d24c5c32f06113237a12afcf43e7757a0",
				OutputMessages: []*types.PartialSignatureMessages{
