		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SignedSSVMessageWithSigner(2, ks.SSVOperatorKeys[2], testingutils.SSVMsgSyncCommitteeContribution(nil, testingutils.PreConsensusContributionProofMsg(ks.Shares[1], ks.Shares[1], 1, 1))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SignedSSVMessageWithSigner(2, ks.SSVOperatorKeys[2], testingutils.SSVMsgAggregator(nil, testingutils.PreConsensusSelectionProofMsg(ks.Shares[1], ks.Shares[1], 1, 1))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SignedSSVMessageWithSigner(2, ks.SSVOperatorKeys[2], testingutils.SSVMsgProposer(nil, testingutils.PreConsensusRandaoDifferentSignerMsgV(ks.Shares[1], ks.Shares[1], 1, 1, spec.DataVersionDeneb))),
				},
