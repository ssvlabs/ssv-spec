...
// DuplicateMsgDifferentRoots tests duplicate PartialSignatureMessages (from same signer) but with different roots
		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SignedSSVMessage{
					...
					testingutils.SSVMsgSyncCommitteeContribution(1, ks.NetworkKeys[1], nil, testingutils.PreConsensusCustomSlotContributionProofMsg(ks.Shares[1], 1, testingutils.TestingDutySlot+1)),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					...
					testingutils.SSVMsgAggregator(1, ks.NetworkKeys[1], nil, testingutils.PreConsensusCustomSlotSelectionProofMsg(ks.Shares[1], 1, testingutils.TestingDutySlot+1)),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					...
					testingutils.SSVMsgProposer(1, ks.NetworkKeys[1], nil, testingutils.PreConsensusRandaoNextEpochMsgV(ks.Shares[1], 1, spec.DataVersionDeneb)),
				},
