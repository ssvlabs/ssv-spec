...
// invalidThenQuorumCBSigningSC returns state comparison object for the invalid then quorum commit boost signing versioned spec test
func invalidQuorumThenValidQuorumCBSigningSC() *comparable.StateComparison {
	ks := testingutils.Testing4SharesSet()
