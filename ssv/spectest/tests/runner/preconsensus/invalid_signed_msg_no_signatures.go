	...
	multiSpecTest := tests.NewMultiMsgProcessingSpecTest(
		...
		[]*tests.MsgProcessingSpecTest{
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					noSignatures(testingutils.SignedSSVMessageWithSigner(1, ks.OperatorKeys[1], testingutils.SSVMsgPTCAttester(nil, testingutils.PreConsensusPTCMsg(ks.Shares[1], 1)))),
				},
				OutputMessages: []*types.PartialSignatureMessages{
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					noSignatures(testingutils.SignedSSVMessageWithSigner(1, ks.OperatorKeys[1], testingutils.SSVMsgEnvelopeProposer(nil, testingutils.PreConsensusEnvelopeMsg(ks.Shares[1], 1)))),
				},
				OutputMessages: []*types.PartialSignatureMessages{
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					noSignatures(testingutils.SignedSSVMessageWithSigner(1, ks.OperatorKeys[1], testingutils.SSVMsgProposerPreferences(nil, testingutils.PreConsensusProposerPreferencesMsg(ks.Shares[1], 1)))),
				},
				OutputMessages: []*types.PartialSignatureMessages{
