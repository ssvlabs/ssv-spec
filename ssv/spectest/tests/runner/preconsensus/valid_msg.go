...
// ValidMessage tests a valid PartialSignatureMessages with multi PartialSignatureMessages
	...
	return &tests.MultiMsgProcessingSpecTest{
		...
		Tests: []*tests.MsgProcessingSpecTest{
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgAttester(1, ks.NetworkKeys[1], nil, testingutils.PreConsensusFailedMsg(ks.Shares[1], 1)),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgSyncCommittee(1, ks.NetworkKeys[1], nil, testingutils.PreConsensusFailedMsg(ks.Shares[1], 1)),
				},
