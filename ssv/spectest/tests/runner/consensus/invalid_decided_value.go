		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				PostDutyRunnerStateRoot: "95b98503fd6ede90e93f20e5f4eef3247e036bf29c4a524ca95fee4ba8061021",
			...
			},
			{
				...
				PostDutyRunnerStateRoot: "0f2b03bb971bec7982e63e2f969e2f8550501e86a07723b0e2d2e6acda789256",
				OutputMessages:          []*ssv.SignedPartialSignatureMessage{},
				ExpectedError:           expectedError,
			},
			{
				...
				PostDutyRunnerStateRoot: "72a59ddd4254168dbf45a531e2c318d1e814fbfc53f9bd650f2e77ebc53dfc91",
				OutputMessages: []*ssv.SignedPartialSignatureMessage{
			...
			},
			{
				...
				PostDutyRunnerStateRoot: "8273ad358f08466cece478e97c5b857dcc2fb5819de31d07e82d9bc71c0ea4df",
				OutputMessages: []*ssv.SignedPartialSignatureMessage{
			...
			},
			{
				...
				PostDutyRunnerStateRoot: "7b366d04a43050ae6197cebfe4e93e87b64d5e3061b9d093727160f233a7b677",
				OutputMessages:          []*ssv.SignedPartialSignatureMessage{},
				ExpectedError:           expectedError,
			},
		},
