...
// InvalidPreConsensusJustifications tests an invalid pre consensus justifications per duty (those who require it and those that don't)
func InvalidPreConsensusJustifications() *tests.MultiMsgProcessingSpecTest {
		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				PostDutyRunnerStateRoot: "f3a2bcae0b58de13eac7ac17d070d85f798483f47d3098aa62c95d6e30a7cc546",
			...
			},
			{
				...
				PostDutyRunnerStateRoot: "77c291167fd56073dc0eb58c25baf96ea463734a2e017c66d1a2db8512da7fc4e",
				OutputMessages: []*types.SignedPartialSignatureMessage{
			...
			},
			{
				...
				PostDutyRunnerStateRoot: "f4704b449fdfe15a92884928e8b3206f1428160df3f17c9f39cc9d1fa017dc342",
				OutputMessages: []*types.SignedPartialSignatureMessage{
			...
			},
			{
				...
				PostDutyRunnerStateRoot: "67b85d530e12cbee105b5db66e13123dcff099e7a66c6e06d474d75897463967f",
				OutputMessages: []*types.SignedPartialSignatureMessage{
			...
			},
			{
				...
				PostDutyRunnerStateRoot: "8d3e35b862b2ca0ec622a6db25db4bc8688b6bae7ea3f230d3fd5670b932d2a36",
				OutputMessages: []*types.SignedPartialSignatureMessage{
					testingutils.PreConsensusRandaoMsg(ks.Shares[1], 1),
					testingutils.PostConsensusProposerMsg(ks.Shares[1], 1),
				},
			},
			{
				...
				PostDutyRunnerStateRoot: "f261ab9f0ba9548723102bc7490110ddd0112a13197850bd3355e839a01c22647",
				OutputMessages: []*types.SignedPartialSignatureMessage{
