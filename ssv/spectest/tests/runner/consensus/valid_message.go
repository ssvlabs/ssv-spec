		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SignedSSVMessage{
					...
					testingutils.TestingProposalMessageWithIdentifierAndFullData(
						ks.NetworkKeys[1], types.OperatorID(1), testingutils.SyncCommitteeContributionMsgID, testingutils.TestSyncCommitteeContributionConsensusDataByts,
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.TestingProposalMessageWithIdentifierAndFullData(
						ks.NetworkKeys[1], types.OperatorID(1), testingutils.SyncCommitteeMsgID, testingutils.TestSyncCommitteeConsensusDataByts,
						qbft.Height(testingutils.TestingDutySlot)),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					...
					testingutils.TestingProposalMessageWithIdentifierAndFullData(
						ks.NetworkKeys[1], types.OperatorID(1), testingutils.AggregatorMsgID, testingutils.TestAggregatorConsensusDataByts,
						qbft.Height(testingutils.TestingDutySlot)),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SSVMsgProposer(1, ks.NetworkKeys[1], nil, testingutils.PreConsensusRandaoMsgV(ks.Shares[1], 1, spec.DataVersionDeneb)),
					testingutils.SSVMsgProposer(2, ks.NetworkKeys[2], nil, testingutils.PreConsensusRandaoMsgV(ks.Shares[2], 2, spec.DataVersionDeneb)),
					testingutils.SSVMsgProposer(3, ks.NetworkKeys[3], nil, testingutils.PreConsensusRandaoMsgV(ks.Shares[3], 3, spec.DataVersionDeneb)),
					testingutils.TestingProposalMessageWithIdentifierAndFullData(
						ks.NetworkKeys[1], types.OperatorID(1), testingutils.ProposerMsgID, testingutils.TestProposerConsensusDataBytsV(spec.DataVersionDeneb),
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					...
					testingutils.SSVMsgProposer(3, ks.NetworkKeys[3], nil, testingutils.PreConsensusRandaoMsgV(ks.Shares[3], 3, spec.DataVersionDeneb)),
					testingutils.TestingProposalMessageWithIdentifierAndFullData(
						ks.NetworkKeys[1], types.OperatorID(1), testingutils.ProposerMsgID, testingutils.TestProposerBlindedBlockConsensusDataBytsV(spec.DataVersionDeneb),
						qbft.Height(testingutils.TestingDutySlotV(spec.DataVersionDeneb))),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.TestingProposalMessageWithIdentifierAndFullData(
						ks.NetworkKeys[1], types.OperatorID(1), testingutils.AttesterMsgID, testingutils.TestAttesterConsensusDataByts,
						qbft.Height(testingutils.TestingDutySlot)),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					...
					testingutils.TestingProposalMessageWithIdentifierAndFullData(
						ks.NetworkKeys[1], types.OperatorID(1), testingutils.ValidatorRegistrationMsgID, testingutils.TestAttesterConsensusDataByts,
						qbft.Height(testingutils.TestingDutySlot)),
				},
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					...
					testingutils.TestingProposalMessageWithIdentifierAndFullData(
						ks.NetworkKeys[1], types.OperatorID(1), testingutils.VoluntaryExitMsgID, testingutils.TestAttesterConsensusDataByts,
						qbft.Height(testingutils.TestingDutySlot)),
				},
				PostDutyRunnerStateRoot: "ec573732e70b70808972c43acb5ead6443cff06ba30d8abb51e37ac82ffe0727",
				OutputMessages: []*types.PartialSignatureMessages{
