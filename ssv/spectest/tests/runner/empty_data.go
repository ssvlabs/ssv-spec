...
// EmptyData tests an invalid message with an empty data
func EmptyData() tests.SpecTest {

	emptyData := func(msg *types.SignedSSVMessage) *types.SignedSSVMessage {
		msg.SSVMessage.Data = make([]byte, 0)
		return msg
	}

	expectedError := "invalid SignedSSVMessage: empty msg data"
		...
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SignedSSVMessage{
					emptyData(testingutils.TestingProposalMessageWithIdentifierAndFullData(
