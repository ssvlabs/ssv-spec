			...
			multiSpecTest.Tests = append(multiSpecTest.Tests, []*committee.CommitteeSpecTest{
				{
					...
					Input:                  testingutils.CommitteeInputForDuties(numSequencedDuties, numValidators, 0, true, false),
				...
				},
				{
					...
					Committee:              testingutils.BaseCommitteeWithRunnerSample(ksMap, testingutils.CommitteeRunnerWithShareMap(shareMap).(*ssv.CommitteeRunner)),
					Input:                  testingutils.CommitteeInputForDuties(numSequencedDuties, 0, numValidators, true, false),
				...
				},
				{
					...
					Committee:              testingutils.BaseCommitteeWithRunnerSample(ksMap, testingutils.CommitteeRunnerWithShareMap(shareMap).(*ssv.CommitteeRunner)),
					Input:                  testingutils.CommitteeInputForDuties(numSequencedDuties, numValidators, numValidators, true, false),
