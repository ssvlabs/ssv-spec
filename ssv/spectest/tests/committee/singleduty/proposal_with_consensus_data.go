...
// ProposalWithConsensusData sends a proposal message to a cluster runner with a ProposerConsensusData (which is wrong since it accepts only BeaconVote objects)
