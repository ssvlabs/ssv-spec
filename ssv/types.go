...
type ProposerCalls interface {
	...
	GetBlindedBeaconBlock(slot phase0.Slot, committeeIndex phase0.CommitteeIndex, graffiti, randao []byte) (*v1.BlindedBeaconBlock, error)
	...
	SubmitBlindedBeaconBlock(block *v1.SignedBlindedBeaconBlock) error
}
