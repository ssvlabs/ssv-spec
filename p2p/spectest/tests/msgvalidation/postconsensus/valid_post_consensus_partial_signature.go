...
func ValidPostConsensusPartialSignature() tests.SpecTest {
	...
	return msgvalidation.NewMsgValidationSpecTest(
		"valid post consensus partial signature",
		testdoc.ValidPostConsensusPartialSignatureDoc,
		msgvalidation.NewRunnerPreset(
			msgvalidation.RunnerTypeCommittee,
			msgvalidation.MarkDecidedStateOp(
