...
func InvalidVote() *tests.MsgProcessingSpecTest {
	...
	msgs := []*alea.SignedMessage{
		testingutils.SignAleaMsg(testingutils.Testing4SharesSet().Shares[1], types.OperatorID(1), &alea.Message{
			...
			Data:       testingutils.ABAAuxDataBytes(byte(2), alea.FirstRound, alea.FirstACRound),
		}),
	}
	return &tests.MsgProcessingSpecTest{
		Name:          "abaaux invalid vote",
		Pre:           pre,
		PostRoot:      "84ecec5237cd4c1ca3ce3044e04e792a8abed2d470f29e1dd9416ac00511eec2",
		InputMessages: msgs,
		ExpectedError: "invalid signed message: ABAAuxData invalid: ABAAuxData: vote not 0 or 1",
		DontRunAC:     true,
	}
}
