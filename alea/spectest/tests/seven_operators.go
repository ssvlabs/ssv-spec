...
func SevenOperators() *MsgProcessingSpecTest {
	...
	// client requests
	signedProposal1 := testingutils.SignAleaMsg(testingutils.Testing7SharesSet().Shares[1], types.OperatorID(1), &alea.Message{
	...
	signedProposal2 := testingutils.SignAleaMsg(testingutils.Testing7SharesSet().Shares[1], types.OperatorID(1), &alea.Message{
		MsgType:    alea.ProposalMsgType,
		Height:     alea.FirstHeight,
		Round:      alea.FirstRound,
		Identifier: []byte{1, 2, 3, 4},
	...
	return &MsgProcessingSpecTest{
		...
		Pre:           pre,
		PostRoot:      "31b8dedbdc6b932008a7f0615731da8dec084760a8660eadc093ff0564497b0e",
