...
func BlameTypeInconsistentMessage_HappyFlow() *tests.MsgProcessingSpecTest {
	...
	return &tests.MsgProcessingSpecTest{
		...
		InputMessages: []*dkg.SignedMessage{
			...
			testingutils.SignDKGMsg(ks.DKGOperators[2].SK, 2, &dkg.Message{
				MsgType:    dkg.ProtocolMsgType,
				Identifier: identifier,
				Data:       makeInvalidForInconsistentMessage(frost.Testing_Round1MessageBytes(2, testingutils.KeygenMsgStore)),
			}),
		},
