...
// Hash: b30d50cd5e1006510ede3e544c566a75ac7e50486c5a7ea3030bde952ff3bb80
// Version: 0.1.3
package types
...
func (s *SSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 4219184 {
		err = ssz.ErrBytesLengthFn("SSVMessage.Data", size, 4219184)
		return
	}
