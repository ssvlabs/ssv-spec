...
// Hash: dde43796d731403cb16f99b3cffa04136e3b9cc33dc6045ec3d66072e5c6fa84
// Version: 0.1.3
package types
...
func (s *SSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 726932 {
		err = ssz.ErrBytesLengthFn("SSVMessage.Data", size, 726932)
		return
	}
...
func (s *SSVMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (2) 'Data'
	{
		...
		hh.Append(s.Data)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (726932+31)/32)
	}
