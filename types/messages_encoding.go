...
// Hash: f8390466bb1e8aa550483c502f5668266497f065f576351db345aa8b4b72c4b5
// Version: 0.1.3
package types
...
func (s *SSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 721628 {
		err = ssz.ErrBytesLengthFn("SSVMessage.Data", size, 721628)
		return
	}
...
func (s *SSVMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (2) 'Data'
	{
		...
		hh.Append(s.Data)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (721628+31)/32)
	}
...
func (s *SignedSSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FullData'
	if size := len(s.FullData); size > 8388836 {
		err = ssz.ErrBytesLengthFn("SignedSSVMessage.FullData", size, 8388836)
		return
	}
...
func (s *SignedSSVMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'FullData'
	{
		...
		hh.MerkleizeWithMixin(elemIndx, byteLen, (8388836+31)/32)
	}
