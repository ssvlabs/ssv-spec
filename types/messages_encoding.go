...
// Hash: e859f3ff80817599afca6140fdc2568b4a7b4391849116da7dca9b42ab9be944
// Version: 0.1.2
package types
...
func (s *SSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 4219064 {
		err = ssz.ErrBytesLengthFn("SSVMessage.Data", size, 4219064)
		return
	}
