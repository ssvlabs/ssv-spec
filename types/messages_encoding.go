...
// Hash: 9a32cc2a66bee2cc945b8b3355cc2731b50ae3eac8925c3e598cdabe93aae00b
// Version: 0.1.3
package types
...
func (s *SignedSSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FullData'
	if size := len(s.FullData); size > 3645633 {
		err = ssz.ErrBytesLengthFn("SignedSSVMessage.FullData", size, 3645633)
		return
	}
...
func (s *SignedSSVMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'FullData'
	{
		...
		hh.MerkleizeWithMixin(elemIndx, byteLen, (3645633+31)/32)
	}
