...
// Hash: ce2760e9d0b588074f1c86a83cfa05934aa30cfe6d49c096e800a382b63efb65
// Version: 0.1.3
package types
...
func (s *SignedSSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 6291893 {
		err = ssz.ErrBytesLengthFn("SignedSSVMessage.Data", size, 6291893)
		return
	}
	dst = append(dst, s.Data...)
