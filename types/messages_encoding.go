...
// Hash: 023e6c0d77a9b931d63d541e71c4924915b0dc9567f9f36853ccc47343e53068
// Version: 0.1.3
package types
...
func (s *SSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 1012015 {
		err = ssz.ErrBytesLengthFn("SSVMessage.Data", size, 1012015)
		return
	}
...
func (s *SSVMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (2) 'Data'
	{
		...
		hh.Append(s.Data)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (1012015+31)/32)
	}
...
func (s *SignedSSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FullData'
	if size := len(s.FullData); size > 4219184 {
		err = ssz.ErrBytesLengthFn("SignedSSVMessage.FullData", size, 4219184)
		return
	}
...
func (s *SignedSSVMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'FullData'
	{
		...
		hh.MerkleizeWithMixin(elemIndx, byteLen, (4219184+31)/32)
	}
