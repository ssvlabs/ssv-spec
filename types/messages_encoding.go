...
// Hash: c0411d253cede500342aa2fc8d7d52233040563292f68a26560c14a8b6b5e9b1
// Version: 0.1.3
package types
...
func (s *SignedSSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FullData'
	if size := len(s.FullData); size > 8388608 {
		err = ssz.ErrBytesLengthFn("SignedSSVMessage.FullData", size, 8388608)
		return
	}
