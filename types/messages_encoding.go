...
// Hash: db17140804caca1dd91f1159c4ff3d58a71ec97397887b9a90ad3f6d7325a7dd
// Version: 0.1.2
package types
...
func (s *SSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 1073872896 {
		err = ssz.ErrBytesLengthFn("SSVMessage.Data", size, 1073872896)
		return
	}
