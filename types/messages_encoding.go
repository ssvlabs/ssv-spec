...
// Hash: 6e04523b0e200d6bd87ed355a00669f6e2119ce101c1dae54a506060f6b95c89
// Version: 0.1.2
package types
...
func (s *SSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 1074003968 {
		err = ssz.ErrBytesLengthFn("SSVMessage.Data", size, 1074003968)
		return
	}
...
func (s *SSVMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (2) 'Data'
	{
		...
		if byteLen > 1074003968 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(s.Data)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (1074003968+31)/32)
	}
