...
// Hash: 855dce6f875048f07fdace38a46c32e2c2dce3c5c177a19e6f4b787709207698
// Version: 0.1.2
package types
...
func (s *SSVMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Data'
	if size := len(s.Data); size > 8421376 {
		err = ssz.ErrBytesLengthFn("SSVMessage.Data", size, 8421376)
		return
	}
...
func (s *SSVMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (2) 'Data'
	{
		...
		hh.PutBytes(s.Data)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (8421376+31)/32)
	}
