...
var TestingProposerDutyV = func(version spec.DataVersion) *types.BeaconDuty {
...
var TestingProposerDutyNextEpochV = func(version spec.DataVersion) *types.BeaconDuty {
	duty := &types.BeaconDuty{
		Type:           types.BNRoleProposer,
		PubKey:         TestingValidatorPubKey,
		ValidatorIndex: TestingValidatorIndex,
