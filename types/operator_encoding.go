...
// Hash: 26d9cca02d9e719990e4e6536f4082e0cf64731829744f0123e46e2a1d083943
// Version: 0.1.3
package types
...
func (o *Operator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'FaultyNodes'
	dst = ssz.MarshalUint64(dst, o.FaultyNodes)
...
func (o *Operator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'FaultyNodes'
	o.FaultyNodes = ssz.UnmarshallUint64(buf[334:342])
