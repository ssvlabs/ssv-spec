...
// Hash: ed2adb64e8228db8acde46731dfc2d2860e174fe96ff9bd2e559f0b580b1d8c7
// Version: 0.1.3
package types
...
func (o *Operator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'SSVPubKey'
	if size := len(o.SSVPubKey); size != 294 {
		err = ssz.ErrBytesLengthFn("Operator.SSVPubKey", size, 294)
		return
	}
	dst = append(dst, o.SSVPubKey...)
...
func (o *Operator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'SSVPubKey'
	if cap(o.SSVPubKey) == 0 {
		o.SSVPubKey = make([]byte, 0, len(buf[56:350]))
	}
	o.SSVPubKey = append(o.SSVPubKey, buf[56:350]...)
