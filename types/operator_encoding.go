...
// Hash: b55a65d2fa112fc71c697326f5cd8f68c173a3c1d71b549b8c2d679778f12d25
// Version: 0.1.3
package types
...
func (o *Operator) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(o.NetworkPubKey); size != 256 {
		err = ssz.ErrBytesLengthFn("Operator.NetworkPubKey", size, 256)
		return
	}
...
func (o *Operator) UnmarshalSSZ(buf []byte) error {
	...
	if cap(o.NetworkPubKey) == 0 {
		o.NetworkPubKey = make([]byte, 0, len(buf[56:312]))
	}
	o.NetworkPubKey = append(o.NetworkPubKey, buf[56:312]...)
