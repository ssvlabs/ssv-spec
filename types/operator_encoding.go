...
// Hash: 3c85470a9183ee9c151f58bdfb2ad95df0e3cadc99597d977692623bf1ca973a
// Version: 0.1.3
package types
...
func (c *CommitteeMember) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'Committee'
	{
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = c.Committee[ii].UnmarshalSSZ(buf[ii*302 : (ii+1)*302]); err != nil {
				return err
			}
		}
	}
...
func (o *Operator) UnmarshalSSZ(buf []byte) error {
	...
	if cap(o.SSVOperatorPubKey) == 0 {
		o.SSVOperatorPubKey = make([]byte, 0, len(buf[8:302]))
	}
	o.SSVOperatorPubKey = append(o.SSVOperatorPubKey, buf[8:302]...)
