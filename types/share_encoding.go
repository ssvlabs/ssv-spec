...
// Hash: d1754973dbebbd095325c924ce087274f9625832cd54f7ef0649d6491bd69a9d
// Version: 0.1.3
package types
...
func (s *Share) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'Quorum'
	s.Quorum = ssz.UnmarshallUint64(buf[108:116])

	// Field (5) 'DomainType'
	copy(s.DomainType[:], buf[116:120])

	// Field (6) 'FeeRecipientAddress'
	copy(s.FeeRecipientAddress[:], buf[120:140])

	// Field (7) 'Graffiti'
	if cap(s.Graffiti) == 0 {
		s.Graffiti = make([]byte, 0, len(buf[140:172]))
	}
	s.Graffiti = append(s.Graffiti, buf[140:172]...)
