...
// Hash: 0fb8503a48a107c64bf004dc3084b9c4186b46d86625b11f75136d2d9f30de79
// Version: 0.1.2
package types
...
func (s *Share) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'NetworkID'
	copy(s.NetworkID[:], buf[108:109])

	// Field (5) 'FeeRecipientAddress'
	copy(s.FeeRecipientAddress[:], buf[109:129])

	// Field (6) 'Graffiti'
	if cap(s.Graffiti) == 0 {
		s.Graffiti = make([]byte, 0, len(buf[129:161]))
	}
	s.Graffiti = append(s.Graffiti, buf[129:161]...)
