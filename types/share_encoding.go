...
// Hash: e62e3a359e40df508e8e4d11b9e51300fc12a551cf4d4d2dfc8ba4228a786530
// Version: 0.1.3
package types
...
func (s *Share) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'FeeRecipientAddress'
	copy(s.FeeRecipientAddress[:], buf[108:128])

	// Field (5) 'Graffiti'
	if cap(s.Graffiti) == 0 {
		s.Graffiti = make([]byte, 0, len(buf[128:160]))
	}
	s.Graffiti = append(s.Graffiti, buf[128:160]...)
