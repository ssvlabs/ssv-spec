...
func NewProposerConsensusDataTest(name, documentation string, cd types.AggregatorCommitteeConsensusData, expectedErrorCode int) *AggregatorCommitteeConsensusDataTest {
