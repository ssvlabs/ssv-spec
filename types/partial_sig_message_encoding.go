...
// Hash: 21fea225c22bc4e791f9ba1d518355b9a7c36401b1f2ac02857893bb044ccba0
// Version: 0.1.3
package types
...
func (p *PartialSignatureMessages) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Messages'
	if size := len(p.Messages); size > 1512 {
		err = ssz.ErrListTooBigFn("PartialSignatureMessages.Messages", size, 1512)
		return
	}
...
func (p *PartialSignatureMessages) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o2:]
		num, err := ssz.DivideInt2(len(buf), 144, 1512)
		if err != nil {
			return err
		}
