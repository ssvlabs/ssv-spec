...
// Hash: 9e3a807c20bb500cb3e72a794f97f7236c8758621bd7aeb38de83b0b8f301c9b
// Version: 0.1.3
package types
...
func (p *PartialSignatureMessages) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Messages'
	if size := len(p.Messages); size > 5048 {
		err = ssz.ErrListTooBigFn("PartialSignatureMessages.Messages", size, 5048)
		return
	}
...
func (p *PartialSignatureMessages) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o2:]
		num, err := ssz.DivideInt2(len(buf), 144, 5048)
		if err != nil {
			return err
		}
...
func (p *PartialSignatureMessages) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (2) 'Messages'
	{
		...
		hh.MerkleizeWithMixin(subIndx, num, 5048)
	}
