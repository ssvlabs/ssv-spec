...
// Hash: 679ede167e13a95e58da5f87e64ff1eed864f9622cad6750f46fd264ae5a9cec
// Version: 0.1.3
package types
...
func (v *ValidatorDuty) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	for ii := 0; ii < len(v.ValidatorSyncCommitteeIndices); ii++ {
		dst = ssz.MarshalUint64(dst, uint64(v.ValidatorSyncCommitteeIndices[ii]))
	}
...
func (v *ValidatorDuty) UnmarshalSSZ(buf []byte) error {
	...
	// Field (8) 'ValidatorSyncCommitteeIndices'
	{
		...
		for ii := 0; ii < num; ii++ {
			v.ValidatorSyncCommitteeIndices[ii] = ValidatorSyncCommitteeIndex(ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8]))
		}
	}
	return err
}
