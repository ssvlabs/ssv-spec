...
// Hash: 44e4c25e3cfef2e47e6bede64cf28b3893792b8976fb5f962856905e00865b8e
// Version: 0.1.3
package types
...
func (c *ConsensusData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'DataSSZ'
	if size := len(c.DataSSZ); size > 3620872 {
		err = ssz.ErrBytesLengthFn("ConsensusData.DataSSZ", size, 3620872)
		return
	}
...
func (c *ConsensusData) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'DataSSZ'
	{
		...
		hh.Append(c.DataSSZ)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (3620872+31)/32)
	}
