...
// Hash: e601e6c589b1acc4ae9c2deaa3bd13ee9d06a283db58709d52badf6ac0aaa7f6
// Version: 0.1.3
package types
...
func (c *ConsensusData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'DataSSZ'
	if size := len(c.DataSSZ); size > 5305388 {
		err = ssz.ErrBytesLengthFn("ConsensusData.DataSSZ", size, 5305388)
		return
	}
...
func (c *ConsensusData) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'DataSSZ'
	{
		...
		hh.Append(c.DataSSZ)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (5305388+31)/32)
	}
