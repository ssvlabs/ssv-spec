...
// Hash: 159212d6d7be1937671e475eab6af89beec81043cea0ff8b17abe2f8f0c9dd79
package types
...
func (c *ConsensusInput) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Data'
	if len(c.Data) > 1125899907230230 {
...
func (c *ConsensusInput) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (1) 'Data'
	{
		...
		if byteLen > 1125899907230230 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(c.Data)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (1125899907230230+31)/32)
	}
