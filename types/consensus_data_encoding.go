...
// Hash: 943a5c7372f1eafb86977240ecf0560bb2de0a0b5722a4c8d9e5edf0049c81f1
// Version: 0.1.3
package types
...
func (a *AggregatorCommitteeConsensusData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	for ii := 0; ii < len(a.AggregatedAttestations); ii++ {
		if size := len(a.AggregatedAttestations[ii]); size > 1048576 {
			err = ssz.ErrBytesLengthFn("AggregatorCommitteeConsensusData.AggregatedAttestations[ii]", size, 1048576)
			return
		}
