...
// Hash: 1db882ced26e8f26a6c24ac01203d5e0e508ddde6469a806dd86a762dc8fc757
// Version: 0.1.3
package types
...
func (c *ConsensusData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'DataSSZ'
	if size := len(c.DataSSZ); size > 4981024 {
		err = ssz.ErrBytesLengthFn("ConsensusData.DataSSZ", size, 4981024)
		return
	}
...
func (c *ConsensusData) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'DataSSZ'
	{
		...
		hh.Append(c.DataSSZ)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (4981024+31)/32)
	}
