...
// Hash: 8c069699b7f7be71164b58ecd4d91a793453881dee66d2ba0ee75b98d098771e
// Version: 0.1.3
package types
...
func (c *ConsensusData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'DataSSZ'
	if size := len(c.DataSSZ); size > 3413116 {
		err = ssz.ErrBytesLengthFn("ConsensusData.DataSSZ", size, 3413116)
		return
	}
...
func (c *ConsensusData) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (3) 'DataSSZ'
	{
		...
		hh.Append(c.DataSSZ)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (3413116+31)/32)
	}
