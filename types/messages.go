...
type SignedSSVMessage struct {
	...
	// Full data max value is the max value between ProposerConsensusData, AggregatorCommitteeConsensusData, EnvelopeConsensusData, BeaconVote, and GloasBeaconVote
